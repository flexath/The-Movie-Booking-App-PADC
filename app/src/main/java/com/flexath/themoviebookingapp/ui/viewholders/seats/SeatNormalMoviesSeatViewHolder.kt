...
class SeatNormalMoviesSeatViewHolder(itemView: View) : SeatBaseMoviesSeatViewHolder(itemView) {

    private var isSelectedSeat:Boolean = false
    init {
        setUpNormalSeatTitle()
        setUpNormalSeatRowName()
        setUpNormalSeatListeners()
    }

    private fun setUpNormalSeatRowName(){
        itemView.tvSeatFirstRowMoviesSeat.text = "A"
        itemView.tvSeatSecondRowMoviesSeat.text = "B"
        itemView.tvSeatTypeRight.tvSeatFirstRowMoviesSeat.text = "A"
        itemView.tvSeatTypeRight.tvSeatSecondRowMoviesSeat.text = "B"
    }

    private fun setUpNormalSeatListeners() {
        onClickSeat1()
        onClickSeat2()
        onClickSeat3()
        onClickSeat4()
