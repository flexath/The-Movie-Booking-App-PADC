...
class SeatPremiumMoviesSeatViewHolder(itemView: View) : SeatBaseMoviesSeatViewHolder(itemView) {

    private var isSelectedSeat:Boolean = false

    init {
        setUpPremiumSeatTitle()
        setUpPremiumSeatRowName()
        setUpPremiumSeatListeners()
    }

    private fun setUpPremiumSeatRowName(){
        itemView.tvSeatFirstRowMoviesSeat.text = "E"
        itemView.tvSeatSecondRowMoviesSeat.text = "F"
        itemView.tvSeatTypeRight.tvSeatFirstRowMoviesSeat.text = "E"
        itemView.tvSeatTypeRight.tvSeatSecondRowMoviesSeat.text = "F"
    }

    private fun setUpPremiumSeatListeners() {
        onClickSeat1()
        onClickSeat2()
        onClickSeat3()
        onClickSeat4()
