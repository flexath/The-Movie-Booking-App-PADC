...
import com.flexath.themoviebookingapp.ui.viewholders.CinemaTimesMoviesCinemaViewHolder

class CinemaTimesCinemaMoviesAdapter : RecyclerView.Adapter<CinemaTimesMoviesCinemaViewHolder>() {
