...
import com.flexath.themoviebookingapp.ui.viewholders.CinemasMoviesCinemaViewHolder

class CinemasCinemaMoviesAdapter : RecyclerView.Adapter<CinemasMoviesCinemaViewHolder>() {
